...
public class GinasticaArtistica implements Winner {
    ...
    public void getWinner(Atleta atleta1, Atleta atleta2) {
        ...
        Double notaMaxima1 = NoteCalculator.higherNote(NoteCalculator.removeMinNote(atleta1));
        Double notaMaxima2 = NoteCalculator.higherNote(NoteCalculator.removeMinNote(atleta2));
